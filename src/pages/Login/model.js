...
export default function FormDialog({setRegistered}) {
    ...
    return (
        <div >
            ...
            <Dialog open={true} onClose={handleClose} aria-labelledby="form-dialog-title" maxWidth='sm' className='modalContainer'>
                <DialogTitle id="form-dialog-title" className='d-flex justify-content-center align-items-center' style={{ fontSize: "20px" }}>Register an Account</DialogTitle>
                <DialogContent>
                    <TextField
                        autoFocus
                        margin="dense"
