        ...
        <div className="left-panel left-panel2">
            ...
            <div className="stats-box">
              <div className="stats-value">
                {dashboard?.allParticipants?.participants_joined_last_24_hours
                  ? dashboard?.allParticipants
                      ?.participants_joined_last_24_hours
                  : 0}
              </div>
          ...
          <div className="wdg-links">
            ...
            {dashboard?.userId && (
              <div className="wdg-box bxset primary">
                <input
                  ...
                  id="myInput1"
                  value={`http://d-app.network/registration?referrallink=${dashboard?.userId}`}
                />
            ...
            <div className="wdg-actions">
              <CopyToClipboard
                text={`http://d-app.network/registration?referrallink=${dashboard?.userId}`}
